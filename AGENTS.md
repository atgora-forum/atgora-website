...
Marketing site and documentation for Barazo at barazo.forum.

## What This Repo Does

- Public-facing marketing pages (homepage, features, pricing)
- User and admin documentation (MDX)
- Blog
